...
Xiaohongshu(RedNote) Video/Photo Downloader\`\`\``);
 try {
            if (!args[0]) return m.reply("[✧] 𝐏𝐨𝐫 𝐟𝐚𝐯𝐨𝐫 𝐞𝐧𝐯í𝐚 𝐞𝐥 𝐞𝐧𝐥𝐚𝐜𝐞 𝐝𝐞𝐥 𝐥𝐚 𝐩𝐥𝐚𝐭𝐚𝐟𝐨𝐫𝐦𝐚 𝐪𝐮𝐞 𝐝𝐞𝐬𝐞𝐚𝐬 𝐝𝐞𝐬𝐜𝐚𝐫𝐠𝐚𝐫!")
            ...
            if (!keni.result || !result.downloadUrls) {
                return m.reply("[✧] 𝐍𝐨 𝐬𝐞 𝐩𝐮𝐝𝐨 𝐝𝐞𝐬𝐜𝐚𝐫𝐠𝐚𝐫 𝐞𝐥 𝐜𝐨𝐧𝐭𝐞𝐧𝐢𝐝𝐨 𝐝𝐞 𝐓𝐢𝐤𝐓𝐨𝐤");
            }
...
> ${wm}`
        ...
        { quoted: m }
                ...
                m.reply("[✧] 𝐅𝐨𝐫𝐦𝐚𝐭𝐨 𝐝𝐞 𝐜𝐨𝐧𝐭𝐞𝐧𝐢𝐝𝐨 𝐧𝐨 𝐫𝐞𝐜𝐨𝐧𝐨𝐜𝐢𝐝𝐨");
            }
