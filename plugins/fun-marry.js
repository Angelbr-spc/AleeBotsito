    ...
    try {
        if (isPropose) {
            ...
            confirmation[proposee] = {
                proposer,
                timeout: setTimeout(() => {
                    conn.sendMessage(m.chat, { text: '*《✧》𝐒𝐞 𝐚𝐜𝐚𝐛ó 𝐞𝐥 𝐭𝐢𝐞𝐦𝐩𝐨, 𝐧𝐨 𝐬𝐞 𝐨𝐛𝐭𝐮𝐯𝐨 𝐫𝐞𝐬𝐩𝐮𝐞𝐬𝐭𝐚. 𝐋𝐚 𝐩𝐫𝐨𝐩𝐮𝐞𝐬𝐭𝐚 𝐝𝐞 𝐦𝐚𝐭𝐫𝐢𝐦𝐨𝐧𝐢𝐨 𝐟𝐮𝐞 𝐜𝐚𝐧𝐜𝐞𝐥𝐚𝐝𝐚.*' }, { quoted: m });
...
handler.before = async (m) => {
    ...
    if (/^No$/i.test(m.text)) {
        ...
        return conn.sendMessage(m.chat, { text: '*《✧》𝐇𝐚𝐧 𝐫𝐞𝐜𝐡𝐚𝐳𝐚𝐝𝐨 𝐭𝐮 𝐩𝐫𝐨𝐩𝐮𝐞𝐬𝐭𝐚 𝐝𝐞 𝐦𝐚𝐭𝐫𝐢𝐦𝐨𝐧𝐢𝐨.*' }, { quoted: m });
    }
