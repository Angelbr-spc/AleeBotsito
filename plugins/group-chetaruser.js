const handler = async (m, { conn }) => {
    ...
    if (m.sender === global.owner.number) { // Reemplaza global.owner.number con tu ID de owner
        await conn.sendMessage(m.chat, { text: '𝐄𝐬𝐭𝐞 𝐜𝐨𝐦𝐚𝐧𝐝𝐨 𝐧𝐨 𝐞𝐬𝐭á 𝐝𝐢𝐬𝐩𝐨𝐧𝐢𝐛𝐥𝐞 𝐩𝐚𝐫𝐚 𝐞𝐥 𝐨𝐰𝐧𝐞𝐫.' }, { quoted: fkontak });
        return;
    }
    ...
    try {
        ...
        await conn.sendMessage(m.chat, { text: '𝐄𝐫𝐫𝐨𝐫 𝐚𝐥 𝐩𝐫𝐨𝐜𝐞𝐬𝐚𝐫 𝐞𝐥 𝐜𝐨𝐦𝐚𝐧𝐝𝐨. 𝐂𝐨𝐧𝐭𝐚𝐜𝐭𝐚 𝐚𝐥 𝐚𝐝𝐦𝐢𝐧𝐢𝐬𝐭𝐫𝐚𝐝𝐨𝐫.' }, { quoted: fkontak }); //Mensaje de error al usuario
    }
};
